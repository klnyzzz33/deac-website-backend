package com.deac.features.payment.service.paypal.impl;
...
public class PaypalPaymentServiceImpl implements PaypalPaymentService {
    ...
    @Autowired
    public PaypalPaymentServiceImpl(UserService userService, PaymentService paymentService, Environment environment) {
